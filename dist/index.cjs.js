...
var Details = styled__default["default"].div(templateObject_2$z || (templateObject_2$z = __makeTemplateObject(["\n  flex: 1;\n  padding-bottom: 12px;\n  padding-left: 12px;\n  padding-right: ", ";\n  padding-top: 12px;\n"], ["\n  flex: 1;\n  padding-bottom: 12px;\n  padding-left: 12px;\n  padding-right: ", ";\n  padding-top: 12px;\n"])), function (_a) {
...
var StyledBreadcrumbs = styled__default["default"].ul(templateObject_2$x || (templateObject_2$x = __makeTemplateObject(["\n  align-items: center;\n  display: flex;\n  flex-wrap: wrap;\n  list-style-type: none;\n\n  a {\n    color: ", ";\n\n    &:hover {\n      color: ", ";\n    }\n  }\n\n  ", "\n"], ["\n  align-items: center;\n  display: flex;\n  flex-wrap: wrap;\n  list-style-type: none;\n\n  a {\n    color: ", ";\n\n    &:hover {\n      color: ", ";\n    }\n  }\n\n  ", "\n"])), function (_a) {
    var theme = _a.theme;
...
var StyledCard = styled__default["default"].div(templateObject_3$d || (templateObject_3$d = __makeTemplateObject(["\n  background: ", ";\n  border-radius: ", ";\n  color: ", ";\n  overflow: hidden;\n  position: relative;\n\n  ", "\n\n  padding: 1px 1px 3px 1px;\n\n  ", "\n"], ["\n  background: ", ";\n  border-radius: ", ";\n  color: ", ";\n  overflow: hidden;\n  position: relative;\n\n  ", "\n\n  padding: 1px 1px 3px 1px;\n\n  ", "\n"])), getBorderColor, function (_a) {
    ...
    return isActive && styled.css(templateObject_2$w || (templateObject_2$w = __makeTemplateObject(["\n      animation: ", " 3s ease infinite;\n      background-size: 400% 400%;\n    "], ["\n      animation: ", " 3s ease infinite;\n      background-size: 400% 400%;\n    "])), PromotedGradient);
}, styledSystem.space);
...
var CheckboxGroupContainer = styled__default["default"](Flex)(templateObject_1$Q || (templateObject_1$Q = __makeTemplateObject(["\n    flex-wrap: wrap;\n"], ["\n    flex-wrap: wrap;\n"])));
var CheckboxContainer = styled__default["default"].div(templateObject_2$u || (templateObject_2$u = __makeTemplateObject(["\n    display: flex;\n    align-items: center;\n"], ["\n    display: flex;\n    align-items: center;\n"])));
...
var Progress = function (_a) {
    ...
    return (React__default["default"].createElement(StyledProgress, { "$useDark": useDark, variant: variant, scale: scale, wrapperColor: wrapperColor },
        ...
        React__default["default"].createElement(Bar, { "$useDark": useDark, primary: true, style: { width: stepGuard(primaryStep) + "%" }, barColor: barColor }),
        secondaryStep ? React__default["default"].createElement(Bar, { "$useDark": useDark, style: { width: stepGuard(secondaryStep) + "%" }, barColor: barColor }) : null));
};
...
var FloatingPanIcon = styled__default["default"](Icon$1)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var MenuItem$1 = function (_a) {
    ...
    return (React__default["default"].createElement(StyledMenuItemContainer, { "$isActive": isActive, "$variant": variant },
        React__default["default"].createElement(StyledMenuItem, __assign({ as: reactRouterDom.Link, to: href, href: href, "$isActive": isActive, "$variant": variant, "$statusColor": statusColor }, props), children)));
};
...
var ImageBox = styled__default["default"].img(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["\n  width: 80px;\n  height: 80px;\n  border: 4px solid ", ";\n  margin: ", ";\n  border-radius: 50%;\n  cursor: pointer;\n"], ["\n  width: 80px;\n  height: 80px;\n  border: 4px solid ", ";\n  margin: ", ";\n  border-radius: 50%;\n  cursor: pointer;\n"])), function (_a) {
...
var StyledButtonSlider = styled__default["default"](Flex)(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  align-items: center;\n  flex-direction: ", ";\n"], ["\n  align-items: center;\n  flex-direction: ", ";\n"])), function (_a) {
    var vertical = _a.vertical;
    return (vertical ? "column" : "row");
});
var ArrowBox = styled__default["default"].div(templateObject_3$4 || (templateObject_3$4 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  transform: ", ";\n  border: 3px solid ", ";\n  border-radius: 50%;\n  cursor: pointer;\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  transform: ", ";\n  border: 3px solid ", ";\n  border-radius: 50%;\n  cursor: pointer;\n"])), function (_a) {
    var vertical = _a.vertical;
...
var Pagination = styled__default["default"].div(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  font-size: 24px;\n  font-weight: bold;\n  color: #FFC85D;\n  flex: 1;\n  text-align: center;\n"], ["\n  font-size: 24px;\n  font-weight: bold;\n  color: #FFC85D;\n  flex: 1;\n  text-align: center;\n"])));
var ButtonSlider = function (props) {
    ...
    var _d = React.useState(defaultIndex), activeIndex = _d[0], setActiveIndex = _d[1];
    ...
    return (React__default["default"].createElement(StyledButtonSlider, { vertical: vertical },
        React__default["default"].createElement(ArrowBox, { vertical: vertical, onClick: handleLeftClick, active: activeIndex > 0 },
            React__default["default"].createElement(Icon$1M, { width: 50, color: activeIndex > 0 ? COLORS.enable : COLORS.disable })),
        type === 'common' ? React__default["default"].createElement(Pagination, null,
            activeIndex + 1,
            "/",
            list.length + 1) :
            list.map(function (item, index) { return (React__default["default"].createElement(ImageBox, { src: item.url, onClick: function () { return handleItemClick(index); }, vertical: vertical, active: index === activeIndex })); }),
        React__default["default"].createElement(ArrowBox, { vertical: vertical, onClick: handleRightClick, active: activeIndex < list.length - 1 },
            React__default["default"].createElement(Icon$1L, { width: 50, color: activeIndex < list.length - 1 ? COLORS.enable : COLORS.disable }))));
};
...
styled__default["default"].div(templateObject_2$9 || (templateObject_2$9 = __makeTemplateObject(["\n  content: \"\";\n  position: fixed;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  background-color: ", ";\n  backdrop-filter: blur(2px);\n"], ["\n  content: \"\";\n  position: fixed;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  background-color: ", ";\n  backdrop-filter: blur(2px);\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text + "99";
});
var templateObject_1$c, templateObject_2$9;

var NavButton = styled__default["default"].a(templateObject_1$b || (templateObject_1$b = __makeTemplateObject(["\n  height: 44px;\n  line-height: 44px;\n  text-align: center;\n  width: 100%;\n  /* padding: 0 18px; */\n  color: #FFFFFF;\n  cursor: pointer;\n  background: #1D2633;\n  /* background: ", "; */\n"], ["\n  height: 44px;\n  line-height: 44px;\n  text-align: center;\n  width: 100%;\n  /* padding: 0 18px; */\n  color: #FFFFFF;\n  cursor: pointer;\n  background: #1D2633;\n  /* background: ", "; */\n"])), function (_a) {
    var isActived = _a.isActived;
    return (isActived ? '#557061' : '');
});
var NavDiv = styled__default["default"].div(templateObject_2$8 || (templateObject_2$8 = __makeTemplateObject(["\n  height: 44px;\n  line-height: 44px;\n  text-align: center;\n  width: 100%;\n  color: #FFFFFF;\n  cursor: pointer;\n  background: #1D2633;\n"], ["\n  height: 44px;\n  line-height: 44px;\n  text-align: center;\n  width: 100%;\n  color: #FFFFFF;\n  cursor: pointer;\n  background: #1D2633;\n"])));
var BottomNav = function (_a) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement(StyledBottomNav, __assign({ justifyContent: "space-around" }, props), items.filter(function (f) { return f.showOnMobile; }).map(function (_a, index) {
            ...
            if (target === '_blank') {
                return React__default["default"].createElement(NavDiv, null,
                    React__default["default"].createElement("a", { target: "_blank", href: href }, label));
            }
...
var MenuItem = function () {
    return (React__default["default"].createElement(StyledFooter, null,
        React__default["default"].createElement(StyledIncubatedBy, null,
            ...
            React__default["default"].createElement("img", { src: "https://crypto-upload.s3.ap-southeast-1.amazonaws.com/cryptoyou/babyswap+logo+black.png", alt: "alt", width: "156px" })),
...
var LinkStatus = styled__default["default"](Text)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  border-radius: ", ";\n  padding: 0 8px;\n  border: 2px solid;\n  border-color: ", ";\n  box-shadow: none;\n  color: ", ";\n  margin-left: 8px;\n"], ["\n  border-radius: ", ";\n  padding: 0 8px;\n  border: 2px solid;\n  border-color: ", ";\n  box-shadow: none;\n  color: ", ";\n  margin-left: 8px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.radii.default;
}, function (_a) {
    var theme = _a.theme, color = _a.color;
...
var MenuItems = function (_a) {
    ...
    return (React__default["default"].createElement(Flex, __assign({}, props), items.map(function (_a) {
        ...
        return (React__default["default"].createElement(DropdownMenu, { key: href + "#" + icon, items: menuItems, py: 1, activeItem: activeSubItem },
            React__default["default"].createElement(MenuItem$1, __assign({ href: isTouchDevice() && menuItems && menuItems.length > 0 ? "" : href, isActive: isActive, statusColor: statusColor, variant: variant }, props, itemsProps), label || React__default["default"].createElement(IconComponent, { iconName: icon, color: isActive ? "secondary" : "textSubtle" }))));
    })));
};
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default["default"].createElement("img", { src: "https://crypto-upload.s3.ap-southeast-1.amazonaws.com/cryptoyou/TCY-logo+1.png", alt: "alt", width: "94px" }));
    ...
    return (React__default["default"].createElement(Wrapper, null,
        React__default["default"].createElement(StyledNav, { showMenu: showMenu },
            React__default["default"].createElement(Flex, null,
                ...
                !isMobile && (React__default["default"].createElement(MenuItems, { items: links, activeItem: activeItem, activeSubItem: activeSubItem, ml: "24px", variant: "header" }))),
            React__default["default"].createElement(Flex, { alignItems: "center" },
                !isMobile && (React__default["default"].createElement(Button, { as: "a", href: "https://exchange.babyswap.finance/#/swap?outputCurrency=0x53e562b9b7e5e94b81f10e96ee70ad06df3d2657", mr: "12px", variant: "secondary", scale: "sm", target: "_blank" }, "Buy $BABY")),
                userMenu)),
