...
var StyledBunnyPlaceholder = styled(Icon$1W)(templateObject_2$o || (templateObject_2$o = __makeTemplateObject(["\n  height: 100%;\n  width: 100%;\n"], ["\n  height: 100%;\n  width: 100%;\n"])));
...
var ImageBox = styled.img(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["\n  width: 80px;\n  height: 80px;\n  border: 4px solid ", ";\n  margin: ", ";\n  border-radius: 50%;\n  cursor: pointer;\n"], ["\n  width: 80px;\n  height: 80px;\n  border: 4px solid ", ";\n  margin: ", ";\n  border-radius: 50%;\n  cursor: pointer;\n"])), function (_a) {
...
var StyledButtonSlider = styled(Flex)(templateObject_2$9 || (templateObject_2$9 = __makeTemplateObject(["\n  align-items: center;\n  flex-direction: ", ";\n"], ["\n  align-items: center;\n  flex-direction: ", ";\n"])), function (_a) {
    var vertical = _a.vertical;
...
var MenuItems = function (_a) {
    ...
    return (React__default.createElement(Flex, __assign({}, props), items.map(function (_a) {
        ...
        return (React__default.createElement(DropdownMenu, { key: href + "#" + icon, items: menuItems, py: 1, activeItem: activeSubItem },
            React__default.createElement(MenuItem$1, __assign({ href: isTouchDevice() && menuItems && menuItems.length > 0 ? "" : href, isActive: isActive, statusColor: statusColor, variant: variant }, props), label || React__default.createElement(IconComponent, { iconName: icon, color: isActive ? "secondary" : "textSubtle" }))));
    })));
};
