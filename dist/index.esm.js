...
import React__default, { isValidElement, cloneElement, Children, useMemo, useCallback, forwardRef, useState, useRef, useEffect, useReducer, createContext, useContext } from 'react';
...
var Details = styled.div(templateObject_2$z || (templateObject_2$z = __makeTemplateObject(["\n  flex: 1;\n  padding-bottom: 12px;\n  padding-left: 12px;\n  padding-right: ", ";\n  padding-top: 12px;\n"], ["\n  flex: 1;\n  padding-bottom: 12px;\n  padding-left: 12px;\n  padding-right: ", ";\n  padding-top: 12px;\n"])), function (_a) {
...
var templateObject_1$13, templateObject_2$z, templateObject_3$f, templateObject_4$b;
...
var templateObject_1$10, templateObject_2$y, templateObject_3$e, templateObject_4$a;
...
var StyledBreadcrumbs = styled.ul(templateObject_2$x || (templateObject_2$x = __makeTemplateObject(["\n  align-items: center;\n  display: flex;\n  flex-wrap: wrap;\n  list-style-type: none;\n\n  a {\n    color: ", ";\n\n    &:hover {\n      color: ", ";\n    }\n  }\n\n  ", "\n"], ["\n  align-items: center;\n  display: flex;\n  flex-wrap: wrap;\n  list-style-type: none;\n\n  a {\n    color: ", ";\n\n    &:hover {\n      color: ", ";\n    }\n  }\n\n  ", "\n"])), function (_a) {
    var theme = _a.theme;
...
var StyledCard = styled.div(templateObject_3$d || (templateObject_3$d = __makeTemplateObject(["\n  background: ", ";\n  border-radius: ", ";\n  color: ", ";\n  overflow: hidden;\n  position: relative;\n\n  ", "\n\n  padding: 1px 1px 3px 1px;\n\n  ", "\n"], ["\n  background: ", ";\n  border-radius: ", ";\n  color: ", ";\n  overflow: hidden;\n  position: relative;\n\n  ", "\n\n  padding: 1px 1px 3px 1px;\n\n  ", "\n"])), getBorderColor, function (_a) {
    ...
    return isActive && css(templateObject_2$w || (templateObject_2$w = __makeTemplateObject(["\n      animation: ", " 3s ease infinite;\n      background-size: 400% 400%;\n    "], ["\n      animation: ", " 3s ease infinite;\n      background-size: 400% 400%;\n    "])), PromotedGradient);
}, space);
...
var templateObject_1$Y, templateObject_2$w, templateObject_3$d, templateObject_4$9;
...
var templateObject_1$T, templateObject_2$v, templateObject_3$c, templateObject_4$8, templateObject_5$4;
...
var Checkbox = styled.input.attrs({ type: "checkbox" })(templateObject_1$R || (templateObject_1$R = __makeTemplateObject(["\n  appearance: none;\n  overflow: hidden;\n  cursor: pointer;\n  position: relative;\n  display: inline-block;\n  height: ", ";\n  width: ", ";\n  vertical-align: middle;\n  transition: background-color 0.2s ease-in-out;\n  border: ", ";\n  border-radius: 8px;\n  background-color: ", ";\n  box-shadow: ", ";\n\n  &:after {\n    content: \"\";\n    position: absolute;\n    border-bottom: 2px solid;\n    border-left: 2px solid;\n    border-color: transparent;\n    top: 30%;\n    left: 0;\n    right: 0;\n    width: 50%;\n    height: 25%;\n    margin: auto;\n    transform: rotate(-50deg);\n    transition: border-color 0.2s ease-in-out;\n  }\n\n  &:hover:not(:disabled):not(:checked) {\n    box-shadow: ", ";\n  }\n\n  &:focus {\n    outline: none;\n    box-shadow: ", ";\n  }\n\n  &:checked {\n    background-color: ", ";\n    &:after {\n      border-color: white;\n    }\n  }\n\n  &:disabled {\n    cursor: default;\n    opacity: 0.6;\n  }\n"], ["\n  appearance: none;\n  overflow: hidden;\n  cursor: pointer;\n  position: relative;\n  display: inline-block;\n  height: ", ";\n  width: ", ";\n  vertical-align: middle;\n  transition: background-color 0.2s ease-in-out;\n  border: ", ";\n  border-radius: 8px;\n  background-color: ", ";\n  box-shadow: ", ";\n\n  &:after {\n    content: \"\";\n    position: absolute;\n    border-bottom: 2px solid;\n    border-left: 2px solid;\n    border-color: transparent;\n    top: 30%;\n    left: 0;\n    right: 0;\n    width: 50%;\n    height: 25%;\n    margin: auto;\n    transform: rotate(-50deg);\n    transition: border-color 0.2s ease-in-out;\n  }\n\n  &:hover:not(:disabled):not(:checked) {\n    box-shadow: ", ";\n  }\n\n  &:focus {\n    outline: none;\n    box-shadow: ", ";\n  }\n\n  &:checked {\n    background-color: ", ";\n    &:after {\n      border-color: white;\n    }\n  }\n\n  &:disabled {\n    cursor: default;\n    opacity: 0.6;\n  }\n"])), getScale$4, getScale$4, function (_a) {
    ...
    return backgroundColor || theme.colors.input;
}, function (_a) {
    var theme = _a.theme;
    return theme.shadows.inset;
}, function (_a) {
    ...
    var theme = _a.theme, checkedColor = _a.checkedColor;
    return checkedColor ? checkedColor : theme.colors.success;
});
...
var CheckboxGroupContainer = styled(Flex)(templateObject_1$Q || (templateObject_1$Q = __makeTemplateObject(["\n    flex-wrap: wrap;\n"], ["\n    flex-wrap: wrap;\n"])));
var CheckboxContainer = styled.div(templateObject_2$u || (templateObject_2$u = __makeTemplateObject(["\n    display: flex;\n    align-items: center;\n"], ["\n    display: flex;\n    align-items: center;\n"])));
...
var CheckboxGroup = function (_a) {
    ...
    var optionsIn = useMemo(function () {
        return options.map(function (i) { return (__assign(__assign({}, i), { checked: value.includes(i.value) })); });
    }, [options, value]);
    return (React__default.createElement(CheckboxGroupContainer, null, optionsIn.map(function (i, index) {
        ...
        return (React__default.createElement(CheckboxContainer, { key: i.value, className: "checkbox-item" },
            React__default.createElement(Checkbox, __assign({ name: i.value, scale: scale, onClick: onClick, checked: i.checked }, props)),
            React__default.createElement(LabelContainer, { scale: scale }, i.label)));
    })));
};
var templateObject_1$Q, templateObject_2$u, templateObject_3$b;
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", backgroundAlt2: "rgba(255, 255, 255, 0.7)", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#280D5F", textDisabled: "#BDC2C4", textSubtle: "#B8BECC", disabled: "#E9EAEB", gradients: {
        ...
        slider: "linear-gradient(90deg, #FFD69B 0%, #FFB751 100%)",
    } });
...
var Bar = styled.div(templateObject_1$x || (templateObject_1$x = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  background-color: ", ";\n  height: 100%;\n  transition: width 200ms ease;\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  background-color: ", ";\n  height: 100%;\n  transition: width 200ms ease;\n"])), function (_a) {
    var theme = _a.theme, $useDark = _a.$useDark, primary = _a.primary, barColor = _a.barColor;
    if (barColor)
        return barColor;
    if ($useDark)
...
var StyledProgress = styled.div(templateObject_2$m || (templateObject_2$m = __makeTemplateObject(["\n  position: relative;\n  background-color: ", ";\n  box-shadow: ", ";\n  overflow: hidden;\n\n  ", " {\n    border-top-left-radius: ", ";\n    border-bottom-left-radius: ", ";\n  }\n\n  ", "\n  ", "\n  ", "\n"], ["\n  position: relative;\n  background-color: ", ";\n  box-shadow: ", ";\n  overflow: hidden;\n\n  ", " {\n    border-top-left-radius: ", ";\n    border-bottom-left-radius: ", ";\n  }\n\n  ", "\n  ", "\n  ", "\n"])), function (_a) {
    var theme = _a.theme, $useDark = _a.$useDark, wrapperColor = _a.wrapperColor;
    if (wrapperColor)
        return wrapperColor;
...
var Progress = function (_a) {
    var _b = _a.variant, variant = _b === void 0 ? variants$2.ROUND : _b, _c = _a.scale, scale = _c === void 0 ? scales$3.MD : _c, _d = _a.primaryStep, primaryStep = _d === void 0 ? 0 : _d, _e = _a.secondaryStep, secondaryStep = _e === void 0 ? null : _e, _f = _a.showProgressBunny, showProgressBunny = _f === void 0 ? false : _f, _g = _a.useDark, useDark = _g === void 0 ? true : _g, wrapperColor = _a.wrapperColor, barColor = _a.barColor;
    return (React__default.createElement(StyledProgress, { "$useDark": useDark, variant: variant, scale: scale, wrapperColor: wrapperColor },
        ...
        React__default.createElement(Bar, { "$useDark": useDark, primary: true, style: { width: stepGuard(primaryStep) + "%" }, barColor: barColor }),
        secondaryStep ? React__default.createElement(Bar, { "$useDark": useDark, style: { width: stepGuard(secondaryStep) + "%" }, barColor: barColor }) : null));
};
...
var bunnyHeadMain = "data:image/svg+xml,%3Csvg%20width%3D%2215%22%20height%3D%2216%22%20viewBox%3D%220%200%2015%2016%22%20fill%3D%22none%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Ccircle%20cx%3D%227.5%22%20cy%3D%228%22%20r%3D%227.5%22%20fill%3D%22%23FFB751%22%2F%3E%3C%2Fsvg%3E";

var bunnyButt = "data:image/svg+xml,%3Csvg%20width%3D%2215%22%20height%3D%2216%22%20viewBox%3D%220%200%2015%2016%22%20fill%3D%22none%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Ccircle%20cx%3D%227.5%22%20cy%3D%228%22%20r%3D%227.5%22%20fill%3D%22white%22%2F%3E%3C%2Fsvg%3E";
...
var BarProgress = styled.div(templateObject_7$1 || (templateObject_7$1 = __makeTemplateObject(["\n  background: ", ";\n  filter: ", ";\n  height: 10px;\n  position: absolute;\n  top: 18px;\n"], ["\n  background: ", ";\n  filter: ", ";\n  height: 10px;\n  position: absolute;\n  top: 18px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.gradients.slider;
}, function (_a) {
    var disabled = _a.disabled;
    return (disabled ? "grayscale(100%)" : "none");
});
var templateObject_1$u, templateObject_2$l, templateObject_3$9, templateObject_4$7, templateObject_5$3, templateObject_6$1, templateObject_7$1;
...
var Slider = function (_a) {
    ...
    var displayValueLabel = valueLabel;
...
var FloatingPanIcon = styled(Icon$1)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var templateObject_1$t, templateObject_2$k, templateObject_3$8, templateObject_4$6, templateObject_5$2;
...
var templateObject_1$r, templateObject_2$j, templateObject_3$7, templateObject_4$5, templateObject_5$1, templateObject_6, templateObject_7;
...
var templateObject_1$q, templateObject_2$i, templateObject_3$6, templateObject_4$4;
...
var MenuItem$1 = function (_a) {
    ...
    return (React__default.createElement(StyledMenuItemContainer, { "$isActive": isActive, "$variant": variant },
        React__default.createElement(StyledMenuItem, __assign({ as: Link$1, to: href, href: href, "$isActive": isActive, "$variant": variant, "$statusColor": statusColor }, props), children)));
};
...
var templateObject_1$l, templateObject_2$f, templateObject_3$5;
...
var ImageBox = styled.img(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["\n  width: 80px;\n  height: 80px;\n  border: 4px solid ", ";\n  margin: ", ";\n  border-radius: 50%;\n  cursor: pointer;\n"], ["\n  width: 80px;\n  height: 80px;\n  border: 4px solid ", ";\n  margin: ", ";\n  border-radius: 50%;\n  cursor: pointer;\n"])), function (_a) {
    _a.theme; var active = _a.active;
    return active ? COLORS.enable : COLORS.disable;
}, function (_a) {
    var vertical = _a.vertical;
    return (vertical ? "15px 0" : "0 15px");
});
var StyledButtonSlider = styled(Flex)(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  align-items: center;\n  flex-direction: ", ";\n"], ["\n  align-items: center;\n  flex-direction: ", ";\n"])), function (_a) {
    var vertical = _a.vertical;
    return (vertical ? "column" : "row");
});
var ArrowBox = styled.div(templateObject_3$4 || (templateObject_3$4 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  transform: ", ";\n  border: 3px solid ", ";\n  border-radius: 50%;\n  cursor: pointer;\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  transform: ", ";\n  border: 3px solid ", ";\n  border-radius: 50%;\n  cursor: pointer;\n"])), function (_a) {
    var vertical = _a.vertical;
    return (vertical ? "rotate(90deg)" : "");
}, function (_a) {
    var active = _a.active;
    return active ? COLORS.enable : COLORS.disable;
});
var Pagination = styled.div(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  font-size: 24px;\n  font-weight: bold;\n  color: #FFC85D;\n  flex: 1;\n  text-align: center;\n"], ["\n  font-size: 24px;\n  font-weight: bold;\n  color: #FFC85D;\n  flex: 1;\n  text-align: center;\n"])));
var ButtonSlider = function (props) {
    var _a = props.list, list = _a === void 0 ? [] : _a, onChange = props.onChange, vertical = props.vertical, _b = props.defaultIndex, defaultIndex = _b === void 0 ? 0 : _b, _c = props.type, type = _c === void 0 ? 'common' : _c;
    var _d = useState(defaultIndex), activeIndex = _d[0], setActiveIndex = _d[1];
    var handleLeftClick = function () {
        if (activeIndex > 0) {
            var index = activeIndex - 1;
            setActiveIndex(index);
            onChange === null || onChange === void 0 ? void 0 : onChange(index, list[index]);
        }
    };
    ...
    return (React__default.createElement(StyledButtonSlider, { vertical: vertical },
        React__default.createElement(ArrowBox, { vertical: vertical, onClick: handleLeftClick, active: activeIndex > 0 },
            React__default.createElement(Icon$1M, { width: 50, color: activeIndex > 0 ? COLORS.enable : COLORS.disable })),
        type === 'common' ? React__default.createElement(Pagination, null,
            activeIndex + 1,
            "/",
            list.length + 1) :
            list.map(function (item, index) { return (React__default.createElement(ImageBox, { src: item.url, onClick: function () { return handleItemClick(index); }, vertical: vertical, active: index === activeIndex })); }),
        React__default.createElement(ArrowBox, { vertical: vertical, onClick: handleRightClick, active: activeIndex < list.length - 1 },
            React__default.createElement(Icon$1L, { width: 50, color: activeIndex < list.length - 1 ? COLORS.enable : COLORS.disable }))));
};
...
var templateObject_1$e, templateObject_2$a, templateObject_3$3, templateObject_4$2;
...
styled.div(templateObject_2$9 || (templateObject_2$9 = __makeTemplateObject(["\n  content: \"\";\n  position: fixed;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  background-color: ", ";\n  backdrop-filter: blur(2px);\n"], ["\n  content: \"\";\n  position: fixed;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  background-color: ", ";\n  backdrop-filter: blur(2px);\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text + "99";
});
var templateObject_1$c, templateObject_2$9;

var NavButton = styled.a(templateObject_1$b || (templateObject_1$b = __makeTemplateObject(["\n  height: 44px;\n  line-height: 44px;\n  text-align: center;\n  width: 100%;\n  /* padding: 0 18px; */\n  color: #FFFFFF;\n  cursor: pointer;\n  background: #1D2633;\n  /* background: ", "; */\n"], ["\n  height: 44px;\n  line-height: 44px;\n  text-align: center;\n  width: 100%;\n  /* padding: 0 18px; */\n  color: #FFFFFF;\n  cursor: pointer;\n  background: #1D2633;\n  /* background: ", "; */\n"])), function (_a) {
    var isActived = _a.isActived;
    return (isActived ? '#557061' : '');
});
var NavDiv = styled.div(templateObject_2$8 || (templateObject_2$8 = __makeTemplateObject(["\n  height: 44px;\n  line-height: 44px;\n  text-align: center;\n  width: 100%;\n  color: #FFFFFF;\n  cursor: pointer;\n  background: #1D2633;\n"], ["\n  height: 44px;\n  line-height: 44px;\n  text-align: center;\n  width: 100%;\n  color: #FFFFFF;\n  cursor: pointer;\n  background: #1D2633;\n"])));
var BottomNav = function (_a) {
    ...
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(StyledBottomNav, __assign({ justifyContent: "space-around" }, props), items.filter(function (f) { return f.showOnMobile; }).map(function (_a, index) {
            var _b, _c;
            ...
            if (target === '_blank') {
                return React__default.createElement(NavDiv, null,
                    React__default.createElement("a", { target: "_blank", href: href }, label));
            }
...
var StyledIncubatedBy = styled.div(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["\n  width: 100%;\n  display: flex;\n  align-items: center;\n  margin-bottom: 35px;\n  justify-content: center;\n\n  ", " {\n    margin-bottom: 49px;\n  };\n"], ["\n  width: 100%;\n  display: flex;\n  align-items: center;\n  margin-bottom: 35px;\n  justify-content: center;\n\n  ", " {\n    margin-bottom: 49px;\n  };\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
...
var LinkStatus = styled(Text)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  border-radius: ", ";\n  padding: 0 8px;\n  border: 2px solid;\n  border-color: ", ";\n  box-shadow: none;\n  color: ", ";\n  margin-left: 8px;\n"], ["\n  border-radius: ", ";\n  padding: 0 8px;\n  border: 2px solid;\n  border-color: ", ";\n  box-shadow: none;\n  color: ", ";\n  margin-left: 8px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.radii.default;
}, function (_a) {
    var theme = _a.theme, color = _a.color;
...
var MenuItems = function (_a) {
    var _b = _a.items, items = _b === void 0 ? [] : _b, activeItem = _a.activeItem, activeSubItem = _a.activeSubItem, variant = _a.variant, props = __rest(_a, ["items", "activeItem", "activeSubItem", "variant"]);
    return (React__default.createElement(Flex, __assign({}, props), items.map(function (_a) {
        var _b, _c;
        var label = _a.label, _d = _a.items, menuItems = _d === void 0 ? [] : _d, href = _a.href, _e = _a.icon, icon = _e === void 0 ? "" : _e, itemsProps = __rest(_a, ["label", "items", "href", "icon"]);
        ...
        return (React__default.createElement(DropdownMenu, { key: href + "#" + icon, items: menuItems, py: 1, activeItem: activeSubItem },
            React__default.createElement(MenuItem$1, __assign({ href: isTouchDevice() && menuItems && menuItems.length > 0 ? "" : href, isActive: isActive, statusColor: statusColor, variant: variant }, props, itemsProps), label || React__default.createElement(IconComponent, { iconName: icon, color: isActive ? "secondary" : "textSubtle" }))));
    })));
};
...
var Menu$1 = function (_a) {
    var _b;
    var userMenu = _a.userMenu, isDark = _a.isDark; _a.currentLang; _a.setLang; _a.cakePriceUsd; var links = _a.links, subLinks = _a.subLinks, activeItem = _a.activeItem, activeSubItem = _a.activeSubItem; _a.langs; var children = _a.children;
